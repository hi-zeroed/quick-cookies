...
struct Localization {
    static func translate(_ key: String, lang: Language) -> String {
        let dict: [String: [Language: String]] = [
            ...
            "Preview files instantly from Terminal using 'qc <path>'.": [.en: "Preview files from Terminal using 'qc <path>'.", .zhHans: "在终端中使用 'qc <path>' 快速预览文件。"],
            ...
            "Enhance your keyboard workflow with Raycast extension and Alfred 5 workflow.": [.en: "Enhance your keyboard workflow with Raycast extension and Alfred 5 workflow.", .zhHans: "通过 Raycast 扩展与 Alfred 5 工作流，在启动器中快速唤起预览与卡片分享。"],
            ...
            "Content": [.en: "Content", .zhHans: "内容"],
            "Lang": [.en: "Language", .zhHans: "语言"],
            "Ratio": [.en: "Aspect Ratio", .zhHans: "比例"],
            ...
            "Esc Cancel · ⌘C Copy · ⌘S Save": [.en: "Esc Cancel · ⌘C Copy · ⌘S Save", .zhHans: "Esc 取消 · ⌘C 拷贝 · ⌘S 保存"],
            "Fit": [.en: "Fit", .zhHans: "适应"],
            "Actual Size": [.en: "Actual Size", .zhHans: "原始大小"],
            "Transparent": [.en: "Transparent", .zhHans: "透明底"],
            "Canvas": [.en: "Canvas", .zhHans: "画幅"],
            "Clear": [.en: "Clear", .zhHans: "清除"],
            "Ambient Glow": [.en: "Ambient Glow", .zhHans: "微光辉光"],
            "Inspect Clipboard": [.en: "Preview Clipboard", .zhHans: "预览剪贴板"],
            "Inspect clipboard content instantly": [.en: "Preview clipboard content", .zhHans: "预览剪贴板中的文本、代码或图片"],
            ...
            "File Info (⌘I)": [.en: "File Info (⌘I)", .zhHans: "文件信息 (⌘I)"],
            "Quick Telemetry Inspector (⌘I)": [.en: "File Info (⌘I)", .zhHans: "文件信息 (⌘I)"],
            "Toggle engineering metadata telemetry bar": [.en: "Toggle file info bar", .zhHans: "显示或隐藏文件信息栏"],
            ...
            "Type": [.en: "Type", .zhHans: "类型"],
            "ViewBox": [.en: "ViewBox", .zhHans: "视口尺寸"],
            "Resolution": [.en: "Resolution", .zhHans: "分辨率"],
            ...
            "Yes": [.en: "Yes", .zhHans: "是"],
            "No": [.en: "No", .zhHans: "否"],
            "Duration": [.en: "Duration", .zhHans: "时长"],
            ...
            "No telemetry available": [.en: "No telemetry available", .zhHans: "暂无详细信息"],
            "Copy Telemetry (⌘C)": [.en: "Copy File Info (⌘C)", .zhHans: "拷贝详细信息 (⌘C)"],
            ...
            "Instant Card Preview for macOS": [.en: "Card File Preview for macOS", .zhHans: "macOS 卡片式文件预览工具"],
            ...
            "Fast Syntax Highlighting": [.en: "Fast Syntax Highlighting", .zhHans: "高效语法高亮"],
            "0ms Instant Streaming Highlight": [.en: "Fast Syntax Highlighting", .zhHans: "高效语法高亮"],
            "Alphabet & Numerals": [.en: "Alphabet & Numerals", .zhHans: "字母与数字"],
            "Waterfall": [.en: "Waterfall", .zhHans: "字阶阶梯"],
            "Play / Pause (Space)": [.en: "Play / Pause (Space)", .zhHans: "播放 / 暂停 (空格)"],
            "Backward 5s": [.en: "Backward 5s", .zhHans: "快退 5 秒"],
            "Forward 5s": [.en: "Forward 5s", .zhHans: "快进 5 秒"],
            "Close": [.en: "Close", .zhHans: "关闭"],
            ...
            "Inspect in Hex": [.en: "Inspect in Hex", .zhHans: "以十六进制查看"],
            "Summary": [.en: "Summary", .zhHans: "概览"],
            "Copied to clipboard": [.en: "Copied to clipboard", .zhHans: "已拷贝至剪贴板"],
            "Open with Application": [.en: "Open with Application", .zhHans: "通过应用程序打开"],
            "More Applications": [.en: "More Applications", .zhHans: "更多应用程序..."],
            ...
            "File not found": [.en: "File not found", .zhHans: "未找到文件"],
            "File not found: %@": [.en: "File not found: %@", .zhHans: "文件不存在: %@"],
            "Folder not found": [.en: "Folder not found", .zhHans: "未找到文件夹"],
            "Access denied to folder": [.en: "Access denied to folder", .zhHans: "无法访问文件夹，权限不足"],
            ...
            "No valid file path found": [.en: "No valid file path found", .zhHans: "未检测到本地文件路径"],
            "Preview with QuickCookies": [.en: "Preview with QuickCookies", .zhHans: "使用 QuickCookies 预览"]
        ]
