...
| REQ-008 | 设置界面 | 提供设置窗口，用于配置触发快捷键、代码/文本字体大小，管理辅助功能权限。 | 需测试 | 已在 SettingsWindow 实现并重构为卡片化高颜值 UI，且已打通“编辑器字体”在预览/编辑界面的动态渲染以及基于 SMAppService 的“开机自启动”自备系统注册逻辑，确保配置项完全真实可用；新增 NSHostingView 宿主 Onboarding 引导。 |
