...
struct Localization {
    static func translate(_ key: String, lang: Language) -> String {
        let dict: [String: [Language: String]] = [
            ...
            "借助系统 Finder 扩展，零隐私风险运行。支持右键菜单预览和默认双击起跳预览。": [.en: "Run with 0 privacy risk using Finder extension. Support right-click menu & default double-press Option.", .zhHans: "借助系统 Finder 扩展，零隐私风险运行。支持右键菜单预览 and 默认双击起跳预览。"],
            ...
            "所有文件夹访问": [.en: "Full Disk Access", .zhHans: "所有文件夹访问"],
            "授权完全磁盘访问，消除受保护文件夹的频繁弹窗。": [.en: "Grant Full Disk Access to avoid folder permission prompts.", .zhHans: "授权完全磁盘访问，消除受保护文件夹的频繁弹窗。"],
            "去授权": [.en: "Grant Access", .zhHans: "去授权"],
            "已尝试启用": [.en: "Attempted", .zhHans: "已尝试启用"],
            "去启用": [.en: "Enable", .zhHans: "去启用"],
            "辅助功能": [.en: "Accessibility", .zhHans: "辅助功能"],
            "辅助功能权限": [.en: "Accessibility", .zhHans: "辅助功能权限"],
            "已授权": [.en: "Authorized", .zhHans: "已授权"],
            "未授权": [.en: "Unauthorized", .zhHans: "未授权"],
            "正在检测...": [.en: "Checking...", .zhHans: "正在检测..."],
            "正在启动...": [.en: "Starting...", .zhHans: "正在启动..."],
            "所有文件夹访问权限": [.en: "Full Disk Access", .zhHans: "所有文件夹访问权限"],
            "授权完全磁盘访问，消除系统安全弹窗": [.en: "Grant Full Disk Access to eliminate sandbox popups", .zhHans: "授权完全磁盘访问，消除系统安全弹窗"],
            "用于全局快捷键与高级动画定位": [.en: "Used for global hotkeys & advanced animations", .zhHans: "用于全局快捷键与高级动画定位"],
